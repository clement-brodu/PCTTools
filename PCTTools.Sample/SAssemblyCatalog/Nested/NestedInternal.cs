...
namespace PCTTools.Sample.SAssemblyCatalog.Nested
{
    internal class NestedInternal
    {
        ...
        private class NestedInternalSubPrivate
        {
        ...
        internal class NestedInternalSubInternal
        {
            public int PropInt { get; set; }
            internal int InternalPropInt { get; set; }
            protected int ProtectedPropInt { get; set; }
        ...
        protected class NestedInternalSubProtected
        {
            public int PropInt { get; set; }
            internal int InternalPropInt { get; set; }
            protected int ProtectedPropInt { get; set; }
        ...
        public class NestedInternalSubPublic
        {
            public int PropInt { get; set; }
            internal int InternalPropInt { get; set; }
            protected int ProtectedPropInt { get; set; }
